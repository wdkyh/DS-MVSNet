...
class BlendedDataset(Dataset):
    ...
    def read_cam(self, filename, scan):
        ...
        depth_interval *= self.scale_factors[scan]
    ...
    def read_depth_and_mask(self, filename, depth_min, scan):
        # read pfm depth file
        # (576, 768)
    ...
    def __getitem__(self, idx):
        ...
        for i, vid in enumerate(view_ids):
            ...
            intrinsics, extrinsics, depth_min, depth_interval = self.read_cam(cam_path, data_name)
            ...
            if i == 0:
                ...
                depth_ms, mask_ms = self.read_depth_and_mask(ref_depth_path, depth_min, data_name)
